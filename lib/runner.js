...
(function() {
  var COLORS, colors, exec, fs, git, html, jobs, mongo, parseSequence, runFile, runNextJob, runTask, runner, server, tokenize, updateLog;
    ...
    return exec(git.runner, {
      ...
      if (error != null) {
        return updateLog(error, true, function() {
          return updateLog(stdout, false, function() {
